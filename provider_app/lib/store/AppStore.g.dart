...
mixin _$AppStore on _AppStore, Store {
  ...
  late final _$expansionDynamicHeightAtom = Atom(name: '_AppStore.expansionDynamicHeight', context: context);
  ...
  set expansionDynamicHeight(double value) {
    _$expansionDynamicHeightAtom.reportWrite(value, super.expansionDynamicHeight, () {
  ...
  late final _$isHelpDeskFirstTimeAtom = Atom(name: '_AppStore.isHelpDeskFirstTime', context: context);
  ...
  late final _$activeRevenueCatIdentifierAtom = Atom(name: '_AppStore.activeRevenueCatIdentifier', context: context);
  ...
  set activeRevenueCatIdentifier(String value) {
    _$activeRevenueCatIdentifierAtom.reportWrite(value, super.activeRevenueCatIdentifier, () {
      super.activeRevenueCatIdentifier = value;
    });
  }

  late final _$providerCurrentSubscriptionAtom = Atom(name: '_AppStore.providerCurrentSubscription', context: context);
  ...
  set providerCurrentSubscription(ProviderSubscriptionModel? value) {
    _$providerCurrentSubscriptionAtom.reportWrite(value, super.providerCurrentSubscription, () {
  ...
  late final _$setIsHelpDeskFirstTimeAsyncAction = AsyncAction('_AppStore.setIsHelpDeskFirstTime', context: context);

  @override
  Future<void> setIsHelpDeskFirstTime(bool val) {
    return _$setIsHelpDeskFirstTimeAsyncAction.run(() => super.setIsHelpDeskFirstTime(val));
  }
  ...
  late final _$setActiveRevenueCatIdentifierAsyncAction = AsyncAction('_AppStore.setActiveRevenueCatIdentifier', context: context);

  @override
  Future<void> setActiveRevenueCatIdentifier(String val) {
    return _$setActiveRevenueCatIdentifierAsyncAction.run(() => super.setActiveRevenueCatIdentifier(val));
  }

  late final _$setProviderCurrentSubscriptionPlanAsyncAction = AsyncAction('_AppStore.setProviderCurrentSubscriptionPlan', context: context);

  @override
  Future<void> setProviderCurrentSubscriptionPlan(ProviderSubscriptionModel val) {
    return _$setProviderCurrentSubscriptionPlanAsyncAction.run(() => super.setProviderCurrentSubscriptionPlan(val));
  }
  ...
  void setExpansionDynamicHeight(double val) {
    final _$actionInfo = _$_AppStoreActionController.startAction(name: '_AppStore.setExpansionDynamicHeight');
    try {
