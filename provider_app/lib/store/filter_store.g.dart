...
mixin _$FilterStore on FilterStoreBase, Store {
  late final _$serviceIdAtom = Atom(name: 'FilterStoreBase.serviceId', context: context);
  ...
  late final _$customerIdAtom = Atom(name: 'FilterStoreBase.customerId', context: context);
  ...
  late final _$bookingStatusAtom = Atom(name: 'FilterStoreBase.bookingStatus', context: context);
  ...
  late final _$paymentStatusAtom = Atom(name: 'FilterStoreBase.paymentStatus', context: context);
  ...
  late final _$paymentTypeAtom = Atom(name: 'FilterStoreBase.paymentType', context: context);
  ...
  late final _$startDateAtom = Atom(name: 'FilterStoreBase.startDate', context: context);
  ...
  late final _$endDateAtom = Atom(name: 'FilterStoreBase.endDate', context: context);
  ...
  late final _$isAnyFilterAppliedAtom = Atom(name: 'FilterStoreBase.isAnyFilterApplied', context: context);
  ...
  late final _$shopIdsAtom = Atom(name: 'FilterStoreBase.shopIds', context: context);
  ...
  late final _$addToServiceListAsyncAction = AsyncAction('FilterStoreBase.addToServiceList', context: context);

  @override
  Future<void> addToServiceList({required int serId}) {
    return _$addToServiceListAsyncAction.run(() => super.addToServiceList(serId: serId));
  }

  late final _$removeFromServiceListAsyncAction = AsyncAction('FilterStoreBase.removeFromServiceList', context: context);

  @override
  Future<void> removeFromServiceList({required int serId}) {
    return _$removeFromServiceListAsyncAction.run(() => super.removeFromServiceList(serId: serId));
  }

  late final _$addToCustomerListAsyncAction = AsyncAction('FilterStoreBase.addToCustomerList', context: context);

  @override
  Future<void> addToCustomerList({required int cusId}) {
    return _$addToCustomerListAsyncAction.run(() => super.addToCustomerList(cusId: cusId));
  }

  late final _$removeFromCustomerListAsyncAction = AsyncAction('FilterStoreBase.removeFromCustomerList', context: context);

  @override
  Future<void> removeFromCustomerList({required int cusId}) {
    return _$removeFromCustomerListAsyncAction.run(() => super.removeFromCustomerList(cusId: cusId));
  }
  ...
  Future<void> addToHandymanList({required int handyId}) {
    return _$addToHandymanListAsyncAction.run(() => super.addToHandymanList(handyId: handyId));
  }
  ...
  Future<void> removeFromHandymanList({required int handyId}) {
    return _$removeFromHandymanListAsyncAction.run(() => super.removeFromHandymanList(handyId: handyId));
  }

  late final _$addToBookingStatusListAsyncAction = AsyncAction('FilterStoreBase.addToBookingStatusList', context: context);
  ...
  Future<void> removeFromBookingStatusList({
    ...
    return _$removeFromBookingStatusListAsyncAction.run(
      () => super.removeFromBookingStatusList(bookingStatusList: bookingStatusList),
    );
  }

  late final _$addToPaymentStatusListAsyncAction = AsyncAction('FilterStoreBase.addToPaymentStatusList', context: context);
  ...
  Future<void> removeFromPaymentStatusList({
    ...
    return _$removeFromPaymentStatusListAsyncAction.run(
      () => super.removeFromPaymentStatusList(paymentStatusList: paymentStatusList),
    );
  }

  late final _$addToPaymentTypeListAsyncAction = AsyncAction('FilterStoreBase.addToPaymentTypeList', context: context);
  ...
  late final _$addToShopListAsyncAction = AsyncAction('FilterStoreBase.addToShopList', context: context);

  @override
  Future<void> addToShopList({required int serId}) {
    return _$addToShopListAsyncAction.run(() => super.addToShopList(serId: serId));
  }

  late final _$removeFromShopListAsyncAction = AsyncAction('FilterStoreBase.removeFromShopList', context: context);

  @override
  Future<void> removeFromShopList({required int serId}) {
    return _$removeFromShopListAsyncAction.run(() => super.removeFromShopList(serId: serId));
  }
