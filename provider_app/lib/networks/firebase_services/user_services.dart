...
class UserService extends BaseService {
  ...
  Future<void> updateUserInfo(Map data, String id, {File? profileImage}) async {
    if (profileImage != null) {
      final String fileName = basename(profileImage.path);
      final Reference storageRef = _storage.ref().child("$PROFILE_IMAGE/$fileName");
  ...
  Future<bool> isUserExistWithUid(String uid) async {
    final Query query = ref!.limit(1).where('uid', isEqualTo: uid);
