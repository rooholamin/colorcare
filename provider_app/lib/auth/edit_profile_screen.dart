...
class EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Future<void> userDetailAPI() async {
    await getUserDetail(appStore.userId).then((value) async {
      ...
      descriptionCont.text = value.data!.whyChooseMeObj.aboutDescription.validate();
      ...
      if (raw.startsWith('+')) {
        ...
        if (m != null) {
          ...
          final String local = (m.group(2) ?? '').replaceAll(RegExp(r'[^\d]'), '');
  ...
  Future<void> update() async {
    final MultipartRequest multiPartRequest = await getMultiPartRequest('update-profile');
    ...
    multiPartRequest.fields[UserKeys.contactNumber] = mobileCont.text.isEmpty ? '' : '+${mobileCont.text.trim().formatPhoneNumber(selectedCountryPicker.phoneCode)}';
      ...
      onSuccess: (data) async {
        ...
        if (data != null) {
          if ((data as String).isJson()) {
            final UserUpdateResponse res = UserUpdateResponse.fromJson(jsonDecode(data));
    ...
    return AppScaffold(
      ...
      body: Stack(
        children: [
                          ...
                          children: [
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: const Icon(AntDesign.camera, color: Colors.white, size: 16).paddingAll(4.0),
                              ).onTap(() async {
                            ...
                            child: Center(
                              child: ValueListenableBuilder(
                                  ...
                                  builder: (context, value, child) {
                                    final code = selectedCountryPicker.phoneCode;
          ...
          if (appStore.isLoading) Observer(builder: (_) => LoaderWidget().center().visible(appStore.isLoading)),
        ],
      ),
    );
  }
