...
class _AddPromotionalBannerScreenState extends State<AddPromotionalBannerScreen> {
  ...
  Future<void> _handlePayment() async {
    if (selectedPaymentSetting!.type == PAYMENT_METHOD_STRIPE) {
      ...
      bool isV2  = selectedPaymentSetting?.isTest == 1 ? selectedPaymentSetting?.testValue?.phonepeVersion == 'v2' ? true : false : selectedPaymentSetting?.liveValue?.phonepeVersion == 'v2' ? true : false;
