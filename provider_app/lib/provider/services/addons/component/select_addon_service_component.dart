...
class SelectAddonServiceComponent extends StatefulWidget {
  ...
  SelectAddonServiceComponent({this.isUpdate = false, this.serviceAddonData, this.selectedServiceId, this.languageCode});
...
class _SelectAddonServiceComponentState extends State<SelectAddonServiceComponent> {
  ...
  Future<void> fetchAllServices({String? searchText = ""}) async {
    ...
    await getServicesList(page, search: searchText, providerId: appStore.userId, languageCode: widget.languageCode.validate()).then((value) {
