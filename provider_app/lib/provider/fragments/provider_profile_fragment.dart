...
class ProviderProfileFragmentState extends State<ProviderProfileFragment> {
  ...
  Future<void> init() async {
    ...
    isForceUpdateEnabled = getBoolAsync(FORCE_UPDATE_PROVIDER_APP, defaultValue: false);
      ...
      builder: (_) {
        return AnimatedScrollView(
          ...
          children: [
            ...
            ).paddingOnly(left: 16, right: 16, top: 24).visible(appStore.isLoggedIn).onTap(() {
              ...
              items: [
                ...
                SettingItemWidget(
                  ...
                  leading: Image.asset(
                    ...
                    height: 16,
                    width: 16,
                    color: appStore.isDarkMode ? const Color.fromRGBO(255, 255, 255, 1) : appTextSecondaryColor,
                  ),
                ...
                if (appStore.userType != USER_TYPE_HANDYMAN && appConfigurationStore.blogStatus)
                  SettingItemWidget(
                    decoration: BoxDecoration(color: context.cardColor),
                ...
                if (appConfigurationStore.serviceAddonStatus && rolesAndPermissionStore.serviceAddOnList)
                  SettingItemWidget(
                    decoration: BoxDecoration(color: context.cardColor),
                    leading: Image.asset(ic_addon_service, height: 16, width: 16, color: appStore.isDarkMode ? const Color.fromRGBO(255, 255, 255, 1) : appTextSecondaryColor),
                ...
                SettingItemWidget(
                  decoration: BoxDecoration(color: context.cardColor, borderRadius: const BorderRadiusDirectional.vertical(bottom: Radius.circular(16))),
                  title: "",
                  highlightColor: Colors.transparent,
                  splashColor: Colors.transparent,
            ...
            SettingSection(
              ...
              headingDecoration: BoxDecoration(color: redColor.withValues(alpha: 0.08), borderRadius: const BorderRadiusDirectional.vertical(top: Radius.circular(16))),
              divider: const Offstage(),
              items: [
                SettingItemWidget(
                  decoration: BoxDecoration(
