                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.only(
                              bottomLeft: isStartDateRadius(date) ? const Radius.circular(24.0) : Radius.zero,
                              topLeft: isStartDateRadius(date) ? const Radius.circular(24.0) : Radius.zero,
                              topRight: isEndDateRadius(date) ? const Radius.circular(24.0) : Radius.zero,
                              bottomRight: isEndDateRadius(date) ? const Radius.circular(24.0) : Radius.zero,
                            ),
                          ),
                        ),
                      ),
                    ...
                    child: InkWell(
                      ...
                      onTap: () {
                        if (widget.minimumDate != null && widget.maximumDate != null) {
                          final DateTime newMinimumDate = widget.minimumDate!.subtract(const Duration(days: 1));
                          final DateTime newMaximumDate = widget.maximumDate!.add(const Duration(days: 1));
