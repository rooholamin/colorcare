                    ...
                    return GestureDetector(
                      onTap: () {
                        if (!providerDocuments[index].providerDocument!.contains('.pdf'))
                          ZoomImageScreen(
                            index: 0,
                            galleryImages: [providerDocuments[index].providerDocument.validate()],
                          ).launch(context);
                      },
                      child: Stack(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(6), color: white.withValues(alpha: 0.8)),
