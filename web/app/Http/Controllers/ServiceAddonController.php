    ...
    public function index_data(DataTables $datatable, Request $request)
    {
        ...
        return $datatable->eloquent($query)
            ...
            ->editColumn('name', function ($query) use ($primary_locale) {
                ...
                // Get the image URL(s) associated with the service addon (assuming 'addon_image' is the media field)
                ...
                // Create a link for service addon editing with the image and name
