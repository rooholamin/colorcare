...
class HandymanPayoutController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($providerEarning < (int)$data['amount']){
        if ( request()->is('api*')){
        ...
        if ($data['payment_method'] === 'wallet') {
            ...
            if($wallet->amount < (int)$data['amount']){
        ...
        if ($providerPayoutUpdate) {
            ...
            $providerPayoutUpdate->update(['amount' => $providerpayout, 'handyman_amount' => $data['amount']]);
        }
