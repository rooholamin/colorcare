...
class DocumentsController extends Controller
{
    public function getDocumentList(Request $request)
    {
        ...
        if ($request->type == "shop_document") {
            $document = $document->where('type', 'shop_document');
        } elseif ($request->type == "provider_document") {
            $document = $document->where('type', 'provider_document');
        }
