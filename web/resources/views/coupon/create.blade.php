                    ...
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            ...
                            @if ($auth_user->can('coupon list'))
                                <a href="{{ route('coupon.index') }}" class=" float-end btn btn-sm btn-primary"><i
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                {{ html()->select(
                                        'discount_type',
                                        ['fixed' => __('messages.fixed'), 'percentage' => __('messages.percentage')],
                                        old('discount_type', $coupondata->discount_type), // <-- pre-filled value here
                                    )->id('discount_type')->class('form-select select2js')->required() }}
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                @endphp
                                {{ html()->select('service_id[]', $assigned_service, $coupondata->serviceAdded->pluck('service_id'))->class('select2js form-group service')->required()->multiple()->attribute('data-placeholder', __('messages.select_name', ['select' => __('messages.service')]))->attribute('data-ajax--url', route('ajax-list', ['type' => 'service-list'])) }}
