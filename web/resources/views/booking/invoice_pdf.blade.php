        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 24px;">
            <tbody style="background: #F6F7F9;">
                ...
                <tr>
                    ...
                    <td style="padding:12px 30px; text-align: end;"></td>
                    <td style="padding:12px 30px; text-align: end;"></td>
                    <td style="padding:12px 30px; text-align: start; color: #6B6B6B;">{{ __('messages.redeem_discount') }} ({{ $bookingdata->redeemed_points }} pts)</td>
                    <td style="padding:12px 30px; text-align: end; color: #219653;">-{{ getPriceFormat($bookingdata->redeemed_discount) }}</td>
                </tr>
                @endif
