               ...
               <div class="position-relative bg-primary p-5 provider-profile-card">
                  ...
                  <div class="mt-3 text-center position-relative">
                     ...
                     <div class="d-flex align-items-center justify-content-center gap-1 mt-2">
                        @if($handymanData['data']['handyman_rating'] > 0)
                            <div>
                                @php
                                    $rating = $handymanData['data']['handyman_rating'];
                                @endphp
                                @for ($i = 0; $i < 5; $i++)
                            ...
                            <span class="h6 text-white">({{ $handymanData['data']['handyman_rating'] }} {{ __('messages.reviews') }})</span>
                        @else
