...
<div class="form-group">
    <div class="form-control d-flex align-items-center justify-content-between">
        ...
        <div class="custom-control custom-switch custom-switch-text custom-switch-color custom-control-inline">
            <input type="checkbox" class="custom-control-input section_5" name="status" id="section_5" data-type="section_5"
...
<div class="row" id='enable_section_5'>
    ...
    <div class="form-group col-md-6">
        ...
        <div class="custom-file">
            <input type="file" name="section5_attachment[]" class="custom-file-input"
                data-file-error="{{ __('messages.files_not_allowed') }}" multiple onchange="preview()">
            @if ($landing_page && getMediaFileExit($landing_page, 'section5_attachment'))
                <label
                    class="custom-file-label upload-label">{{ $landing_page->getFirstMedia('section5_attachment')->file_name }}</label>
            @else
                <label
                            ...
                            @foreach ($attchments as $attchment)
                                ...
                                <div class="col-md-2 pe-10 text-center galary file-gallary-{{ $landing_page->id }} position-relative"
                                    ...
                                    <a class="text-danger remove-file"
                                        href="{{ route('remove.file', ['id' => $attchment->id, 'type' => 'section5_attachment']) }}"
