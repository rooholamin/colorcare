...
<div id='enable_section_2'>
    ...
    <div class="form-group" id='enable_select_category'>
        ...
        <br />
        {{ html()->select('category_id[]', [], old('category_id'))->class('select2js form-control category_id')->id('category_id')->attribute('data-placeholder', __('messages.select_name', ['select' => __('messages.category')]))->attribute('data-ajax--url', route('ajax-list', ['type' => 'category_footer', 'is_featured' => 1]))->multiple() }}
    </div>
</div>
